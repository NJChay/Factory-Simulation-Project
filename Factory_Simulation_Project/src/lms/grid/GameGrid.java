...
public class GameGrid {
    ...
    /**
     * A map of each coordinate to the grid component
    ...
    public Map<Coordinate, GridComponent> getGrid() {
        Map<Coordinate, GridComponent> copy = new HashMap<>();
        //Ensures the grid being returned is a copy
        for (Coordinate coords : grid.keySet()) {
            copy.put(coords, grid.get(coords));
        }
        return copy;
